...
reaper.ShowConsoleMsg("8 MIDI voice tracks routed to C700.\n")
reaper.ShowConsoleMsg("Default channel -> slot mapping (set by C700 on init):\n")
for v = 1, 8 do
  reaper.ShowConsoleMsg("  Voice " .. v .. " -> Channel " .. v .. " -> Slot " .. (v-1) .. "\n")
end
